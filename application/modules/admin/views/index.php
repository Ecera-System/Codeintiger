                            ...
                            <ul class="sidebar-menu metismenu" id="sidebar-menu">
                                ...
                                <li>
                                    ...
                                    <ul class="sidebar-nav">
                                        ...
                                        <li>
                                            <a href="auth/create_group"> Add Groups </a>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                    ...
                                    <ul class="sidebar-nav">
                                        <li>
                                            <a href="auth"> Manage Users </a>
                                        </li>
                                        <li>
                                            <a href="auth/create_user"> Add User </a>
                                        </li>
                                    </ul>
                                ...
                                <li>
                                    ...
                                    <ul class="sidebar-nav">
                                        ...
                                        <li>
                                            <a href="admin/users"> User Permissions </a>
                                        </li>
                                       <li>
                                            <a href="admin/groups"> Group Permissions </a>
                                        </li>
                                        <li> 
                                            <a href ="admin/add_permission"> Add Permissions</a>
                                        </li> 
                                    </ul>
                                </li>
                                <li>
                                    <a href="">
                                        ...
                                        <ul class="sidebar-nav">
                                        <li>
                                            <a href="admin/settings"> Manage Site Settings </a>
                                        </li>
                                        <li>
                                            <a href="admin/addSetting"> Add Setting </a>
                                        </li>
                                       <li>
                                            <a href="admin/deleteSetting"> Delete Settings </a>
                                        </li>
                                    </ul>
                                </li>
                                <li>
